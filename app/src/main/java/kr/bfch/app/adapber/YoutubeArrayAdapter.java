 ...
 */
public final class YoutubeArrayAdapter extends ArrayAdapter<YoutubeListViewItem> {

  private final LayoutInflater inflater;

  public YoutubeArrayAdapter(Context context, int textViewResourceId, List<YoutubeListViewItem> objects) {
